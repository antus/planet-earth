...
function initWidgetView(_thisWidget) {
  ...
  $("#btnCenter").click(function (e) {
    ...
    var currentOptions = thisWidget.map.getCurrentOptions();
    currentOptions.lang = 1;
    thisWidget.map.setOptions(currentOptions);
    thisWidget.map.setSceneOptions({"sceneMode": 2});
  })
  ...
  $("#btn_plot_savefile").click(function () {
    let data = thisWidget.map.getCurrentOptions()
    haoutil.file.downloadFile("mapConfig.json", JSON.stringify(data))
  })
