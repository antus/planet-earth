  ...
  class MyWidget extends es5widget.BaseWidget {
    ...
    create() {
      this.data = window.toolBarMenuData || [
        { name: "Dashboard", icon: "fa fa-tasks", widget: "widgets/antus/oil-spill/dashboard/widget.js"},
        { name: "Panel", icon: "fas fa-layer-group", widget: "widgets/antus/panel/widget.js" },
        { name: "Operation", icon: "fas fa-tv", widget: "widgets/antus/oil-spill/operation/widget.js" },
        { name: "Oil Forecast", icon: "fas fa-solar-panel", widget: "widgets/antus/oil-spill/forecast/widget.js" }
