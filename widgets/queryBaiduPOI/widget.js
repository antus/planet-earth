      ...
      if (counts == 0) {
        ...
        for (let index = 0; index < data.length; index++) {
          ...
          inhtml += `<div class="querybar-site" onclick="queryGaodePOIWidget.showDetail('${_id}')">
            <div class="querybar-sitejj">
              ...
              <a id="btnShowDetail" href="${item.detailUrl}" target="_blank" class="querybar-more">More></a> </h3>
              <p> ${item.address || ""}</p>
            </div>
          </div> `
        ...
        if (this.allpage > 1) {
          _fyhtml =
            ...
            "/" +
            this.allpage +
            'Page <a href="javascript:queryBaiduPOIWidget.showFirstPage()">Homepage</a> <a href="javascript:queryBaiduPOIWidget.showPretPage()"><</a> <a href="javascript:queryBaiduPOIWidget.showNextPage ()">></a> </div>'
        } else {
          _fyhtml = ""
        }
